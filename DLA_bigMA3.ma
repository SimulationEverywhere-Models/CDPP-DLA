...
initialvalue : -1
initialCellsValue : dla_big3.val
...
% initialize the cells with mobile particles in the range with 40% of concentration
rule : {round(uniform(1,4))} 100 { (0,0) = -1 and random < 0.40 }  
